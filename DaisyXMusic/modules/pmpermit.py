    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
                "**Xoş Gəldiniz MusicAzE🎵🇦🇿 Assistantına**\n\n**🛑 Qaydalar:**\n1. Burda Spam Etməyin. \n2. Burda Söhbət etməyin.\n\n**⚠️ Disclamer:** Buraya bir mesaj göndərirsinizsə, demək admin mesajınızı görəcək və söhbətə qatılacaq\n    - Bu istifadəçini gizli qruplara əlavə etməyin.\n   - Şəxsi məlumatları burada paylaşmayın\n\n",
            ) 
            return
